...
> 日期：2026-07-25（2026-07-26 回填落地记录）
...
| **既有缺陷（非本期引入）**：显式记忆陈述落降级话术 | 「记住，我最喜欢吃草莓味的甜品」**记忆确实存进去了，话术却是「抱歉，我没听清」**——不落任何能力域的记忆陈述会走空计划降级话术。用户体感是「没听懂」，实则已记住。建议进 M1b nightly badcase 族 |
