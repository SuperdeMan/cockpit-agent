...
- 全量 **7670 passed / 32 skipped 零红**（4:19）。本跳 **7646 → 7670 = +24**，
  ...
  **拿副本做逐文件 collect-only diff 是对的，拿它的 pass 数当基线是错的**。
  `test_planning_safety_talk.py` 0 → 12 / `test_safety_focus.py` 15 → 20 /
  `test_execution_claim.py` 16 → 20 / `agents/reminder/tests/test_agent.py` 64 → 67 ＝ **24**，
  其余测试文件计数逐字未变。
