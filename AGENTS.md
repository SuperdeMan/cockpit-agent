...
换店三跳连修（planning 补 store_hint 依赖边 / executor 同轮补全 / **hint 未命中
绝不顶替**——唯一可用店给「选择麦当劳门店：X」确定句式）。全旅程真栈：瑞幸聚合
菜单主卡 10 款、预览温度 chips、**改规格生效（冰→热）**、换店/取消；麦当劳诚实
查无句原样附加、选店句直达 105 款 14 分类导航。⚠ **事实边界**：麦当劳 MCP 测试
账号官方可点门店当前仅碧海君庭一家（商户侧数据限制，系统侧已诚实化）。
聚焦回归 **1260 绿**；流水 history **§32.1**。
