...
`python -m pytest -q -n 8 --dist worksteal` = **7708 passed / 32 skipped 零红**（5:15）。
本跳 **7691 → 7708 = +17**，与本批新增用例数**逐字相符**：
