...
- **AR04 当前交接**：[跨页语音宿主与提醒呈现 ACK 实施记录](../docs/design/2026-09-08-ar04-presentation-ack-implementation.md) 第十二节。代码 / OPPO 包 `065efd85e`，726 tests / tsc 通过，2026-09-08 17:12:17 安装、哈希已核对。获授权的地图临时兼容配置、5 个退出场景、5 条真实提醒与服务端回执已验证；后台 / 熄屏恢复各新增一次播放、零采集。**安全 Keyguard、物理折叠/旋转组合未验，未整批签收**；新发现的提醒错域/标题污染和对话胶囊文案只作问题记录。
