...
| `manual-rag` | Xiaomi SU7 真实车主手册问答：生产 `a406e22` 为文本检索；v2 本地候选增加安全落域、受控图标俗称和图文证据卡，待发布 |
...
- **停车仍为 mock Provider**；手册已在生产 `a406e22` 使用真实 Xiaomi SU7 文本索引，
  图文 v2 仍处于未发布候选态。两者不得混写成同一条 mock 边界。
