...
- **语音输入采纳修复（2026-09-11）**：[实施与验收边界](../docs/design/2026-09-11-android-voice-input-acceptance.md)：免唤醒来源贯通、手动录音 `ptt` 非受话拒识、自身播报疑似回声留输入框核对、拒识后无声恢复。OPPO 已装 `f8fd15152` prod 包；云端扩展尚未发布，声学未验收。
