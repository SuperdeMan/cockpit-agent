...
**最新后端全量基线（2026-08-28 MiniMax QA 修复批**第 6 批**，`target=cloud` +
本地 Docker 已退）**：`python -m pytest -q -n auto --dist worksteal` =
**7631 passed / 32 skipped 零红**。
本跳 `7598 → 7631` = **+33，全部是第 6 批（C15/C16）新增的探针断言**
...
对账链：**7631**（08-28 QA 修复批第 6 批）← 7598（08-28 第 5 批）← 7547（08-28 第 4 批）← 7493（08-28 第 3 批）← 7397（08-28 第 2 批）← 7314（08-28 第 1 批）← 7225（08-26 发布治理/测试族）← 7106（08-25 MiniMax QA 闭环）← 6969（08-24 MiniMax QA 批）← 6933（08-22 I-030 批）← 6902（08-22 复验批）← 6897（08-21 规格值域批）
