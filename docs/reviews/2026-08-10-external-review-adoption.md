...
| 批次 | 方案文档 | 性质 | 启动时机 |
|---|---|---|---|
| **B1 执行安全停止线** | [`../design/2026-08-10-b1-execution-safety-stopline.md`](../design/2026-08-10-b1-execution-safety-stopline.md) | P0+P1-high 修复 + 安全证据 | **立即**（未完成前冻结新增业务 Agent） |
| **B2 意图门禁进 CI 与主干治理** | [`../design/2026-08-10-b2-gate-ci-branch-governance.md`](../design/2026-08-10-b2-gate-ci-branch-governance.md) | CI 阻断 + 治理 | 立即（与 B1 无依赖，可并行） |
