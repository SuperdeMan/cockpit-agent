...
冒烟通过）。当前全量单测 910 passed, 6 skipped（2026-06-26，含 trip-planner 结构化重构 P0/P1 +29 测试）；compose 含 info-agent。
