...
> 日期：2026-07-25
> 状态：**✅ P0/P1/P2 全落地并真栈验证（2026-07-25，落地记录见 §10）**；§8 三个决策点泓舟拍板「都按你建议的来」。
...
> **已归档**：定稿内容已并入架构文档 v1.5 §7.1（`docs/architecture/cockpit-agent-architecture.md`）——架构是唯一真相源，本 RFC 保留作设计过程与决策依据的记录。
