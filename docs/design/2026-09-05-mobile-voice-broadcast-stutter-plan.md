...
| 修前（HEAD a09c73a 之前的 providers.py） | **79** | 0.92s | 243.2s（190s 音频） | **4 次 × 60s** | **4 个：18.6 / 19.3 / 18.1 / 18.4s，位于 43 / 102 / 163 / 223s** |

修前那行就是 Xiaomi 上听到的形态（4 个 ~20s 空白、60s 一个周期）在本机的复刻；同文同账号，唯一变量是发送策略。
