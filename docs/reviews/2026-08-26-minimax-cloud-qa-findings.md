...
> **第 1、2、3 批已于 2026-08-28 落地**：第 1 批 C1 安全告警链 / C2 端侧车控三 bug /
...
> **下一批 = 第 5 批**：C9（P1-06 天气城市漂移 + N6）、C12（P2-14 偏好）、C13（P1-15 时限）、
> C14（P1-11 落域半边）、C11（N4/P1-10 编造半边 + P2-17 话术半边）。
> **下一批 = 第 4 批 C6+C5+C7+C8（复合句族）**。
