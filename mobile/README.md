...
- **AR04 当前交接**：[实施记录第十三节](../docs/design/2026-09-08-ar04-presentation-ack-implementation.md)。当前代码 / OPPO 包 `573ad46d9`，mobile 726、reminder 220 tests 与 CI 通过；播放提示已在真机修复，标题修复未部署。默认模式及全屏 drawer/tabletop/book/合拢返回的草稿/本地征询保留已验证；**原 16:9 显示比例、定位/动效等 App 偏好均已恢复，测试 App 已退出**。真正 Keyguard 提醒、服务端多 operationId 实机组合及发布仍待接续，未整批签收。
