...
def test_request_ref_mapping_holds_the_real_live_inventory(monkeypatch):
    ...
    # 2026-09-26 +63 → 14009：手册口语召回批两处判别化描述，条数不变。`manual.query` 写明「部件与
