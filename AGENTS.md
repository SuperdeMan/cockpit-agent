...
全量 **3647 passed / 11 skipped / 0 failed**（2026-08-02 单进程实测；较 M-D 时的 3597 净 **+50**＝M5 P3 收尾 +33［判别化描述 16 / 对象桥接台账 15 / 分词 golden 1 / catalog 1］＋影子四路径与 θ 档 16［`test_nlu_shadow_paths.py`］＋CI 收口 1［recover 无操作回归］，另有若干断言按新意图改写不计净增）；HMI 225/225 + build；Go 网关 vet+test 通过。
