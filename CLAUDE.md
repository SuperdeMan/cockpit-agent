...
**探索式真实用户 QA 轮**（2026-08-15 立卡 / 2026-08-17 持续推进，架构 **v1.29**）：
533 轮 × 5 persona × 两档跑出的 58 个问题收敛成 **13 个根因**（Q1–Q13），四阶段推进。
已交付 Q1/Q3/Q4/Q13/Q2（载体）/**Q7（三维度全收口）**/Q5（写入闸 + 出处披露）/Q11/
Q10（三块）/Q6/**存量数据清洗**/Q12（槽值保真主体 + 中文时间词三份实现收敛）；
契约面新增 `conventions.md` **§9.19–§9.26** 八条。
