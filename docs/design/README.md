...
| 文档 | 主题 | 状态 |
|---|---|---|
| [2026-06-13-vehicle-control-command-architecture.md](2026-06-13-vehicle-control-command-architecture.md) | 车控域升级到「公版语音指令表」统一 schema（架构设计） | P1 已落地：知识库三件套 + VAL 升级 + fast_intent 扩展 + 101 测试；P2/P3 待做 |
| [2026-06-13-multi-intent-and-context.md](2026-06-13-multi-intent-and-context.md) | 多意图拆分 + 对话上下文/指代消解 | 大部分落地：上下文已做 + 云侧 DAG 强化 + 黄金用例；端侧切分层待做 |
| [2026-06-13-asr-pipeline-analysis.md](2026-06-13-asr-pipeline-analysis.md) | ASR 收音失败根因分析与修复链 | 大部分落地：前端竞态 + 后端转码 + ffmpeg；剩 HTTPS 部署 + E2E 待做 |
